...
import { CheckCircle, XCircle, Share2, ArrowLeft, Utensils } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="flex items-center justify-center gap-12 mb-8">
        {isValidImageUrl(food.image) ? (
          ...
          <div className="w-64 h-64 flex items-center justify-center bg-orange-100 rounded-lg shadow-lg">
